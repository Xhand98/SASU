...
async def tutorial_command(ctx: discord.ApplicationContext, language: str = "en"):
    ...
    if language == "en":
        ...
        tutorial_text = (
            ...
            "Para vincular tu cuenta de Steam con el bot, necesitarás proporcionar tu SteamID. "
            "Aquí te explicamos cómo hacerlo:\n"
            "### 1. Encuentra tu SteamID:\n"
            "###    - Si ya conoces tu SteamID, puedes saltarte este paso. De lo contrario, "
            "usa uno de los siguientes métodos:\n"
            "    Método: Abre tu perfil de Steam en un navegador, copia la URL y pégala en "
            "`/getsteamid`. El resultado será tu SteamID.\n\n"
            "## 2. Vincula tu SteamID con el Bot\n"
            "Una vez que tengas tu SteamID, puedes vincularla a tu cuenta de Discord usando "
            "el siguiente comando:\n"
            "`</setup:1275183733116370947> steamid:<tu_steamid>`\n"
            "Reemplaza `<tu_steamid>` con tu SteamID real.\n\n"
            "## 3. Verifica tu Configuración\n"
            "Para comprobar si tu SteamID se ha vinculado correctamente, usa el siguiente "
            "comando:\n"
            "`</showinfo:1275183733116370949>`\n"
            "El bot responderá con tu SteamID vinculada si todo está configurado correctamente.\n\n"
            "## 4. Usar Otros Comandos\n"
            "Ahora que tu SteamID está vinculada, puedes usar otros comandos para obtener "
