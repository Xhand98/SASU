    ...
    async def tutorial_command(self, ctx: discord.ApplicationContext, language: str = "en"):
        ...
        if language == "en":
            tutorial_text = (
                ...
                "To check if your SteamID is successfully linked, use the"
                " following command:\n"
                "</showinfo:1275183733116370948>\n"
                "This will display the information stored for your account.\n\n"
                "## 4. Getting Help\n"
                "If you encounter any issues or need further assistance, feel free to reach out to the support team.\n"
                "You can also use the </help:1275183733116370949> command to get a list of available commands and their descriptions.\n\n"
                "Thank you for using the Steam Bot! We hope you enjoy the experience.\n"
            )
        else:
            tutorial_text = (
                "# ¡Bienvenido al Tutorial de Configuración del Bot de Steam!\n\n"
                "## 1. Configurando tu SteamID\n"
                "Para vincular tu cuenta de Steam con el bot, necesitarás proporcionar tu SteamID. Aquí te mostramos cómo hacerlo:\n"
                "### 1. Encuentra tu SteamID:\n"
                "###   - Si ya conoces tu SteamID, puedes omitir este paso. De lo contrario, utiliza uno de los siguientes métodos:\n"
                "      El Método: Abre tu perfil de Steam en un navegador, copia la URL y pégala en </tutorial:1275183733116370950>, el resultado es tu SteamID.\n\n"
                ...
                "Para verificar si tu SteamID se ha vinculado correctamente, usa el siguiente comando:\n"
                "</showinfo:1275183733116370948>\n"
                "Esto mostrará la información almacenada para tu cuenta.\n\n"
                "## 4. Obteniendo Ayuda\n"
                "Si encuentras algún problema o necesitas más ayuda, no dudes en contactar al equipo de soporte.\n"
                "También puedes usar el comando </help:1275183733116370949> para obtener una lista de comandos disponibles y sus descripciones.\n\n"
                "Gracias por usar el Bot de Steam! Esperamos que disfrutes la experiencia.\n"
            )
